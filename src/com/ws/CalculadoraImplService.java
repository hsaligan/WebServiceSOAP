 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://ws.com/", wsdlLocation = "http://localhost:1515/WS/Calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://ws.com/", "CalculadoraImplService");
    ...
    public Calculadora getCalculadoraImplPort() {
        return super.getPort(new QName("http://ws.com/", "CalculadoraImplPort"), Calculadora.class);
    }
    ...
    public Calculadora getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.com/", "CalculadoraImplPort"), Calculadora.class, features);
    }
